...
<script src="<%=request.getContextPath() %>/resources/js/app/attendance/attendace.js"></script>
					...
					<div class="card info-card sales-card">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between mt-3">
								<div class="col-md-6">
									<button id="checkInButton" class="btn btn-primary rounded-pill btn-sm" onclick="onCheckInButtonClick()">출근</button>
									<span id="checkInDisplay" class="time-display">${attVO.attInTime}</span>
								</div>
								<div class="col-md-6">
									<button class="btn btn-secondary rounded-pill btn-sm" onclick="onCheckOutButtonClick()">퇴근</button>
								...
								<tbody>
									<tr>
										<th scope="row"><a href="#"><img
												src="${pageContext.request.contextPath }/resources/in/assets/img/product-1.jpg" alt=""></a></th>
									...
									<tr>
										<th scope="row"><a href="#"><img
												src="${pageContext.request.contextPath }/resources/in/assets/img/product-2.jpg" alt=""></a></th>
									...
									<tr>
										<th scope="row"><a href="#"><img
												src="${pageContext.request.contextPath }/resources/in/assets/img/product-3.jpg" alt=""></a></th>
									...
									<tr>
										<th scope="row"><a href="#"><img
												src="${pageContext.request.contextPath }/resources/in/assets/img/product-4.jpg" alt=""></a></th>
									...
									<tr>
										<th scope="row"><a href="#"><img
												src="${pageContext.request.contextPath }/resources/in/assets/img/product-5.jpg" alt=""></a></th>
				...
				<div class="card-body pb-0">
					...
					<div class="news">
						<div class="post-item clearfix">
							<img src="${pageContext.request.contextPath }/resources/in/assets/img/news-1.jpg" alt="">
							<h4>
						...
						<div class="post-item clearfix">
							<img src="${pageContext.request.contextPath }/resources/in/assets/img/news-2.jpg" alt="">
							<h4>
						...
						<div class="post-item clearfix">
							<img src="${pageContext.request.contextPath }/resources/in/assets/img/news-3.jpg" alt="">
							<h4>
						...
						<div class="post-item clearfix">
							<img src="${pageContext.request.contextPath }/resources/in/assets/img/news-4.jpg" alt="">
							<h4>
						...
						<div class="post-item clearfix">
							<img src="${pageContext.request.contextPath }/resources/in/assets/img/news-5.jpg" alt="">
							<h4>
