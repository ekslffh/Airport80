					...
					<div class="card-header" style="padding-bottom: 5px; margin-bottom: 15px;">
						...
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">반입불가 물품 상세보기</li>
								<li class="breadcrumb-item active">반입불가 물품 수정</li>
							</ol>
						</nav>
					</div>
					<!-- 게시판 헤더 영역 끝 -->
...
<form:form method="post" modelAttribute="confisInfo">
	...
	<table class="table table-border">
		...
		<tr>
			...
			<input type="submit" value="수정" class="btn btn-primary" style="margin-right:4px;"/> 
