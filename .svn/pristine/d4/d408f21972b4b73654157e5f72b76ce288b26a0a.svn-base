						 ...
						 <p class="cofistooltip">
							  <i class="bi bi-exclamation-circle-fill" style="margin-right: 4px;"></i> 
							       <span data-bs-toggle="tooltip" data-bs-placement="top">
							       	  항목을 누르면 상세보기가 표시됩니다.<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;우측 하단 버튼으로 선택 메일을 영구삭제하거나 복구할 수 있습니다.
							       </span>
							   </p>
					  </div>
...
<%--                                         <td>${status.index}</td> --%>
 							 ...
 							 <button type="button" id="recoverButton" class="btn btn-primary" style="margin-right: 10px;">선택 메일 복구</button>
