...
@Controller
public class ReceiveMailDetailController {

    @GetMapping("/account/mail/detail.do")
    public String mailDetail(@RequestParam("messageIndex") int messageIndex,
    		Model model,
        ...
        return "accounting/mailbox/inboxDetail";
    }
