			...
			<div class="card">
				<div class="card-body">
					...
					<div class="card-header" style="padding-bottom: 5px; margin-bottom: 15px;">
						...
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">입국금지자 수정</li>
							</ol>
						</nav>
					</div>
					<!-- 게시판 헤더 영역 끝 -->
					...
					<form:form method="post" action="${pageContext.request.contextPath }/safety/ppersonUpdate.do" modelAttribute="enterPerson">
						...
						<div class="row mb-3">
							<label for="inputText" class="col-sm-2 col-form-label">입국금지사유</label>
							<div class="col-sm-3">
						...
						<div class="row mb-3">
							<label for="inputDate" class="col-sm-2 col-form-label">입국금지지간</label>
							<div class="col-sm-3">
						...
						<input type="hidden" name="ppWw" value="in">
