...
<main>
	...
	<section id="hero" class="hero">
		...
		<div class="info d-flex align-items-center">
			<div class="container">
				<div class="table-title">도착 항공편 조회</div>
				<div class="container mt-4" style="margin-bottom: 20px;">
					<form id="searchForm" action="${path}/flights/flightArrivals" method="post">
						<div class="row">
							<div class="col-md-2">
							...
							<tbody>
								...
								<c:if test="${not empty flights}">
									<c:forEach items="${flightList}" var="flight">
										<tr>
											<th scope="row"><i class="bx bxs-plane-land"></i></th>
											<c:choose>
