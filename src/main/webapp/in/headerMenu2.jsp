...
<div class="d-flex align-items-center justify-content-between">
	<a href="index.html" class="logo d-flex align-items-center"> <img
		src="resources/in/assets/img/logo.png" alt=""> <span
	...
	<ul class="d-flex align-items-center">
		...
		<li class="nav-item dropdown"><a class="nav-link nav-icon"
			...
			<ul
				...
				<li class="message-item"><a href="#"> <img
						src="resources/in/assets/img/messages-1.jpg" alt=""
				...
				<li class="message-item"><a href="#"> <img
						src="resources/in/assets/img/messages-2.jpg" alt=""
						class="rounded-circle">
						<div>
							<h4>Anna Nelson</h4>
							<p>Velit asperiores et ducimus soluta repudiandae labore
				...
				<li class="message-item"><a href="#"> <img
						src="resources/in/assets/img/messages-3.jpg" alt=""
						class="rounded-circle">
						<div>
							<h4>David Muldon</h4>
							<p>Velit asperiores et ducimus soluta repudiandae labore
		...
		<li class="nav-item dropdown pe-3"><a
			...
			data-bs-toggle="dropdown"> <img
				src="resources/in/assets/img/profile-img.jpg" alt="Profile"
